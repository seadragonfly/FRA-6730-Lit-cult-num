...
Le git contient l’ensemble du [code](./scripts/) (reproductible) en Python écrit pour cette implémentation, ainsi que le [modèle pratique](./data/json/) pour chaque spectacle. Enfin, cet exercice de modélisation est accompagné d’une [discussion](./text/description.md) sur ses possibilités et de ses limites.
